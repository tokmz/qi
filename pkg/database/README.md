...
```go
// 开发环境：启用 SQL 追踪便于调试
db.Use(database.NewTracingPlugin(database.WithSQLTrace(true)))
```
...
- **db.operation**: 操作类型（gdatabase.Create/Query/Update/Delete/Row/Raw）
- **db.table**: 表名
...
- [GORM 官方文档](https://gdatabase.io/docs/)
