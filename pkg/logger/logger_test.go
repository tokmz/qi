...
func TestLoggerWithContext(t *testing.T) {
	...
	// 测试带 trace_id / uid 的标准库 context.Context
	ctx2 := context.WithValue(context.Background(), logger.ContextKeyTraceID(), "trace-123")
	ctx2 = context.WithValue(ctx2, logger.ContextKeyUID(), int64(12345))
...
func TestLoggerWithContextMethod(t *testing.T) {
	...
	// 创建带 trace_id / uid 的标准库 context.Context
	ctx := context.WithValue(context.Background(), logger.ContextKeyTraceID(), "trace-456")
	ctx = context.WithValue(ctx, logger.ContextKeyUID(), int64(67890))
